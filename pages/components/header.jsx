        ...
        <div className="h-14 w-screen flex px-6 absolute justify-between">
            <div className="w-1/2 flex md:w-1/3 ">
                <a className="flex items-center">
                    ...
                    <div className="text-xl font-bold md:text-2xl">Picowind</div>
                </a>
            </div>
            <div className="hidden">2</div>
            <div className="hidden">3</div>
            <div className="w-1/2 flex items-center justify-end md:text-2xl">
                <a className="font-bold text-lg flex items-center" href="mailto:ethangalva@gmail.com">
                    <div className="text-xl font-bold pr-1 hover:underline">Email Us</div>
