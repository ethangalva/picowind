    ...
    return (
        <div className="bg-[#ecede8]">
            <div className="flex flex-col p-6 gap-4 justify-between bg-[#e2dbd0] rounded-t-3xl">
                {/* TITLE */}
                <h2 className="font-bold text-2xl">Our Project</h2>
                {/* SERVICES BOXES */}
                <div className="justify-center w-full flex flex-col gap-8">
                    <div className="rounded-xl flex-col gap-2 flex">
                        <div className="bg-[url('../public/windturbine1.jpg')] bg-center bg-no-repeat bg-cover w-full h-72 sepia rounded-2xl hover:sepia-[.8] cursor-pointer"></div>
                    ...
                    <div className="rounded-xl flex-col gap-2 flex">
                        <div className="bg-[url('../public/windturbine2.jpg')] bg-center bg-no-repeat bg-cover w-full h-72 sepia rounded-2xl hover:sepia-[.8] cursor-pointer"></div>
