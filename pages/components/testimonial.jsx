export default function Testimonial() {
    return (
        <div className="bg-[#e2dbd0]">
            <div className="flex flex-col p-6 gap-4 justify-between bg-[#ecede8] rounded-t-3xl">
                {/* TITLE */}
                <h2 className="font-bold text-2xl">Testimonials<br /> From Partners</h2>
                {/* TESTIMONIALS */}
                <div className="overflow-hidden flex flex-col gap-8">
                    <div className="w-full flex flex-col gap-2 border border-neutral-400 rounded-xl p-4">
                    ...
                    <div className="w-full flex flex-col gap-2 border border-neutral-400 rounded-xl p-4 hover:bg-neutral-300">
